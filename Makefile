...
str_start.o uint16_pack.o uint16_unpack.o uint32_pack.o uint32_unpack.o
...
cacheserver: \
load cacheserver.o cacherequesthandler.o hash.o socket_accept.o socket_bind.o \
alloc.a buffer.a byte.a libtai.a unix.a
	./load cacheserver cacherequesthandler.o hash.o socket_accept.o socket_bind.o \
	alloc.a buffer.a byte.a libtai.a unix.a
